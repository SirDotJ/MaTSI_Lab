package org.togu.controllers.lab6;
...
import org.togu.lab6.ElGamal;
import org.togu.lab6.User;
...
public class ElGamalController {
	...
	public void openHelp() {
		HelpController.open("Криптосистема Эль-Гамаля", "ElGamalDescription.md");
	}
}
